...
<img src="images/logo.png" style="margin-top:-200px; padding-top:30px;margin-bottom: -248px; margin-left: -200px; height: 500px; width: 700px;"></img>
        ...
        <div id="fb"><a href="https://www.facebook.com/events/641836059265283/" ><img src="images/fb.png" height="35px" width="35px" style="border-radius:35px;background-color:rgba(255,255,255,0.8);padding:2px;margin-top:10px;" title="Visit Us at Facebook"/></a></div>
        <div id="menu">
            <ul>
    ...
    <div id="main">
    	<div style="width:960;margin:0px;">
            ...
            <div  style="border-radius:15px;background-color:rgba(255,255,255,0.4);padding:25px;width:250px;float:right;">
                ...
                <div class="lbe_box">
                    <h3>&bull; Event will begin on 17th October 2014 at 12:00 p.m.</h3>
