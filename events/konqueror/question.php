<?php 
	...
	if (isset($_SESSION['isregistered_konqueror']) && $_SESSION['isregistered_konqueror']) 
	{
		...
		$query = "SELECT score FROM user_info_kon where user_id='".$_SESSION['user_konqueror']."'";
		$result=mysql_query($query);
		$x = mysql_fetch_array($result);
		$qid = $x['score'] + 1;
		$_SESSION['score'] = $x['score'];
		//echo $qid;
		$query = "SELECT question FROM question_info_kon where qid='{$qid}'";
            ...
            <div style="border-radius:15px;background-color:rgba(255,255,255,0.4);padding:25px;min-height:430px;width:600px;float:left;">
                    ...
                    <?php
						...
						//}
							...
							echo 'Q'.($qid). ': <img width=" 520" id="qq" src="e70e871b22a811907ed3a2927f6ced37/'.$question.'.png" >' ;
							echo 
