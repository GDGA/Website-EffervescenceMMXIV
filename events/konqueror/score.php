            ...
            <div style="border-radius:15px;background-color:rgba(255,255,255,0.4);padding:25px;min-height:430px;width:600px;float:left;">
					...
					<?php
						...
						if (!isset($_SESSION['isregistered_konqueror']))
							...
							//else if ($ready>0)
							//echo 'Scores would be visible after the competition begins';
						else {
							include "dbconnect.php";
							$query = "SELECT user_id , score , time FROM user_info_kon ORDER  BY score desc,time LIMIT 0,100";
            ...
            <div style="border-radius:15px;background-color:rgba(255,255,255,0.4);padding:25px;margin-bottom:30px;width:250px;float:right;">
                ...
                <div class="lbe_box" id="lbox">
					<?php
						...
						session_start();
						if($_SESSION['isregistered_konqueror'])
							echo '
								<h2>Welcome</h2>'.
...
<h2>Latest Updates</h2>
                ...
                <div class="lbe_box">
                    <h3>&bull; It will be an 24hr long event</h3>                    <div class="cleaner"></div>
                </div>
