    ...
    <div id="main">
    	<div style="width:960;margin:0px;">
            ...
            <div style="border-radius:15px;background-color:rgba(255,255,255,0.4);padding:25px;min-height:485px;width:600px;float:left;">
                    ...
                    <div class="cleaner">
				This is an event of numbers and ciphers. You will be given an encrypted message and a key and a little bit of our support via hint of the problem. You have to figure out the original message.So get ready to enter into this cryptoworld.			
                    </div>
              	</div>
            ...
            <div style="border-radius:15px;background-color:rgba(255,255,255,0.4);padding:25px;margin-bottom:30px;width:250px;float:right;">
                ...
                <div class="lbe_box" id="lbox">
					<?php
						...
						session_start();
						if(isset($_SESSION['isregistered_platzen']) && $_SESSION['isregistered_platzen']==1)
							echo '
								<h2>Welcome</h2>'.
