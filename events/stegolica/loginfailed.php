    	...
    	<div style="width:960;margin:0px;">
            ...
            <div style="border-radius:15px;background-color:rgba(255,255,255,0.4);padding:25px;margin-bottom:30px;width:250px;float:right;">
                ...
                <div class="lbe_box" id="lbox">
					<h5 ><a style="text-decoration:none">You have not registered for the event. Please do so <a href="http://fe.iiita.ac.in/register/?page=login" target="new"><u>here.</u></a></a></h5>
					<?php
 						session_start();
						echo $_SESSION['user_stegolica'];
						if (isset($_SESSION['isregistered_perplexuz']) && $_SESSION['isregistered_perplexuz']==1)
							echo '
								<h2>Welcome</h2>'.$_SESSION['user_perplexuz'];
						else
							echo '
								<h2>Login</h2>
