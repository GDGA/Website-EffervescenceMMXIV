...
$('#spons-box').transition({'left':'0px','opacity':'1'});
...
{
$('#spons-box').transition({'left':'-500px','opacity':'0'});
...
function showSpons(id, backgrounds)
{
  ...
  if(backgrounds[id-1] != prev){
    ...
    $('#spons-box').animate({'margin-left':'-300px'},function(){
      $('.spons_slides').hide();
